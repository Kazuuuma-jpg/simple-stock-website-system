                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            ...
                            <a href="export_keluar.php" class="btn btn-success">Cetak ke Excel</a>
                        </div>
                        ...
                        <div class="card-body">
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    <?php
                                    // Mengambil data barang keluar dari database (join dengan stock)
                                    ...
                                    <div class="modal fade" id="edit<?= $idk; ?>" tabindex="-1" aria-labelledby="editLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="editLabel">Edit Data Barang Keluar</h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                                <form method="post">
                                                    <div class="modal-body">
                                                        <label for="new_idb_keluar">Nama Barang:</label>
                                                        <select name="new_idb" class="form-control mb-2" id="new_idb_keluar">
                                                            <?php
                                                        ...
                                                        <input type="text" id="penerima_edit" name="penerima" value="<?= $penerima; ?>" class="form-control mb-2" placeholder="Penerima" required>
                                                        <br>
                                                        <label for="qty_edit">Jumlah:</label>
                                                        <input type="number" id="qty_edit" name="qty" value="<?= $qty; ?>" class="form-control mb-2" placeholder="Jumlah" required>
                                                        <br>
                                                        <input type="hidden" name="idk" value="<?= $idk; ?>">
                                                        <input type="hidden" name="old_idb" value="<?= $idb; ?>">
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Tutup</button>
                                                        <button type="submit" class="btn btn-warning" name="updatebarangkeluar">Simpan Perubahan</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="modal fade" id="delete<?= $idk; ?>" tabindex="-1" aria-labelledby="deleteLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="deleteLabel">Hapus Data Barang Keluar</h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                                <form method="post">
                                                    <div class="modal-body">
                ...
                <form method="post">
                    <div class="modal-body">
                        ...
                        <select name="barangnya" class="form-control" id="barangnya" required>
                            <?php
                            // Ambil semua data barang dari tabel stock
                        ...
                        <label for="qty_keluar">Jumlah:</label>
                        <input type="number" id="qty_keluar" name="qty" class="form-control" placeholder="Jumlah" required>
                        <br>

                        <label for="penerima_keluar">Penerima:</label>
                        <input type="text" id="penerima_keluar" name="penerima" placeholder="Penerima" class="form-control" required>
                        <br>
